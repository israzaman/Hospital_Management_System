...
namespace HospitalManagementSystem
{
    public partial class HospitalManagementForm : Form
    {
        ...
        private void rdoctorbutton_Click(object sender, EventArgs e)
        {
            ...
            List<Doctor> dlist = da.doctordatagrid();
        ...
        private void rnursebutton_Click(object sender, EventArgs e)
        {
            ...
            List<Nurse> nlist = da.nursedatagrid();
        ...
        private void rroombutton_Click(object sender, EventArgs e)
        {
            ...
            List<Room> rlist = da.roomdatagrid();
        ...
        private void patientregbutton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    da.patient_admit(pnametextBox.Text, paddresscomboBox.Text, gender, pdobdateTimePicker.Text, pcontacttextBox.Text, pstatuscombobox.Text, proomcomboBox.Text,loginName);
        ...
        {
            Receptionist rec = new Receptionist();
            rec = da.checkOldPassword(loginName);
            ...
            else
            {
                if (currentpasstextBox.Text == rec.Password)
                {
                    ...
                    {
                        da.changePassword(loginName, newtextBox.Text);
            ...
            else
            {
                ...
                else
                {
                    if (doctorsearchbycomboBox.SelectedItem.ToString() == "Name")
                    {
                        doctordataGridView.DataSource = null;
                        doctordataGridView.Rows.Clear();
                        List<Doctor> dlist = da.getDoctorByName(doctorsearchtextBox.Text);
                        if (dlist.Count != 0)
                        {
                            foreach (var item in dlist)
                            {
                    ...
                    else if (doctorsearchbycomboBox.SelectedItem.ToString() == "Designation")
                    {
                        doctordataGridView.DataSource = null;
                        doctordataGridView.Rows.Clear();
                        List<Doctor> dlist = da.getDoctorByDes(doctorsearchtextBox.Text);
                        if (dlist.Count != 0)
                        {
                            foreach (var item in dlist)
                            {
            ...
            else
            {
                ...
                else
                {
                    if (patientsearchcomboBox.SelectedItem.ToString() == "Name")
                    {
                        pdataGridView.DataSource = null;
                        pdataGridView.Rows.Clear();
                        List<Patient> plist = da.getPatientByName(patientsearchtextBox.Text);
                        if (plist.Count != 0)
                        {
                            foreach (var item in plist)
                            {
                    ...
                    else if (patientsearchcomboBox.SelectedItem.ToString() == "Roomno")
                    {
                        pdataGridView.DataSource = null;
                        pdataGridView.Rows.Clear();
                        List<Patient> plist = da.getPatientByroom(patientsearchtextBox.Text);
                        if (plist.Count != 0)
                        {
                            foreach (var item in plist)
                            {
            ...
            else
            {
                ...
                else
                {
                    if (nursesearchcomboBox.SelectedItem.ToString() == "Name")
                    {
                        nursedataGridView.DataSource = null;
                        nursedataGridView.Rows.Clear();
                        List<Nurse> nlist = da.getNurseByName(nursesearchtextBox.Text);
                        if (nlist.Count != 0)
                        {
                            foreach (var item in nlist)
                            {
                    ...
                    else if (nursesearchcomboBox.SelectedItem.ToString() == "Designation")
                    {
                        nursedataGridView.DataSource = null;
                        nursedataGridView.Rows.Clear();
                        List<Nurse> nlist = da.getNurseByDes(nursesearchtextBox.Text);
                        if (nlist.Count != 0)
                        {
                            foreach (var item in nlist)
                            {
            ...
            else
            {
                ...
                else
                {
                    if (roomsearchcomboBox.SelectedItem.ToString() == "Roomno")
                    {
                        roomdataGridView.DataSource = null;
                        roomdataGridView.Rows.Clear();
                        List<Room> rlist = da.getRoomByRoomno(roomsearchtextBox.Text);
                        if (rlist.Count != 0)
                        {
                            foreach (var item in rlist)
                            {
                    ...
                    else if (roomsearchcomboBox.SelectedItem.ToString() == "Roomtype")
                    {
                        roomdataGridView.DataSource = null;
                        roomdataGridView.Rows.Clear();
                        List<Room> rlist = da.getRoomByRoomtype(roomsearchtextBox.Text);
                        if (rlist.Count != 0)
                        {
                            foreach (var item in rlist)
                            {
                    ...
                    else if (roomsearchcomboBox.SelectedItem.ToString() == "Roomstatus")
                    {
                        roomdataGridView.DataSource = null;
                        roomdataGridView.Rows.Clear();
                        List<Room> rlist = da.getRoomByRoomstatus(roomsearchtextBox.Text);
                        if (rlist.Count != 0)
                        {
                            foreach (var item in rlist)
                            {
                    ...
                    else if (roomsearchcomboBox.SelectedItem.ToString() == "Roomcost")
                    {
                        roomdataGridView.DataSource = null;
                        roomdataGridView.Rows.Clear();
                        List<Room> rlist = da.getRoomByRoomcost(roomsearchtextBox.Text);
                        if (rlist.Count != 0)
                        {
                            foreach (var item in rlist)
                            {
